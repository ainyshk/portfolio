...
```bash
make -C _projects/foo build
make -C _projects/foo docs # docs are not in make dev
```
...
const sprite = gameEnv.path + '/images/projects/foo/knight.png';
